...
const ListModel = __importStar(require("../Models/ListModel"));
const getLists = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const resModel = yield ListModel.getAllLists();
        res.json(resModel);
    }
    catch (error) {
...
const createList = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield ListModel.createList(resModel);
...
const updateList = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const data = req.body;
        yield ListModel.updateList(parseInt(id), data);
...
const deleteList = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        yield ListModel.deleteList(parseInt(id));
